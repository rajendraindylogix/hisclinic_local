<?php
/*
* Plugin Name: NWS Product Subscriptions
* Plugin URI: https://nirmal.com.au/
* Plugin Based on: https://github.com/Prospress/woocommerce-subscribe-to-all-the-things
