...
class RP_WCEC_Email extends RP_WCEC_Post_Object
{
    ...
    public function print_list_column_value($column_key)
    {
        switch ($column_key) {
            ...
            case 'email_subject':
                ...
                RightPress_Help::print_link_to_post($this->get_id(), $this->get_subject(), '<span class="rp_wcec_row_title_cell">', '</span>' . $note);
    ...
    {
        return RightPress_Help::post_type_is($id, self::$post_type);
    }
    ...
    {
        $locales['rp_wcec_editor_buttons'] = RP_WCEC_PLUGIN_PATH . 'includes/rp-wcec-tinymce-locales.inc.php';
        return $locales;
    }
     ...
     * @return string
     */
    public function get_email_headers($customer_email = null, $send_to_admin = false, $args = array())
    {
        $headers = '';
        ...
        return apply_filters('rp_wcec_email_headers', $headers, $this, $customer_email, $send_to_admin, $args);
    }
    ...
    public function get_email_content_by_type($content_type, $recipient_email, $log = null)
    {
        ...
        // Include template
        RightPress_Help::include_template($template, RP_WCEC_PLUGIN_PATH, 'woocommerce-email-center', $this->args);
    ...
    public function file_delete()
    {
        ...
        if (empty($_REQUEST['object']) && !RightPress_Help::post_type_is($_REQUEST['object'], $this->get_post_type())) {
            return;
        }
    ...
    public function render_meta_box_recipients($post)
    {
        ...
        // Load view
        include RP_WCEC_PLUGIN_PATH . 'views/' . $object->get_post_type_short() . '/recipients.php';
    }
    ...
    public function render_meta_box_attachments($post)
    {
        ...
        // Load view
        include RP_WCEC_PLUGIN_PATH . 'views/' . $object->get_post_type_short() . '/attachments.php';
    }
    ...
    public function render_meta_box_formatting($post)
    {
        ...
        // Load view
        include RP_WCEC_PLUGIN_PATH . 'views/' . $object->get_post_type_short() . '/formatting.php';
    }
    ...
    public function render_meta_box_private_note($post)
    {
        ...
        // Load view
        include RP_WCEC_PLUGIN_PATH . 'views/' . $object->get_post_type_short() . '/private-note.php';
    }
