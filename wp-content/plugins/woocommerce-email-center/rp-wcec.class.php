...
class RP_WCEC
{
    ...
    public function __construct()
    {
        ...
        load_textdomain('rightpress', WP_LANG_DIR . '/' . RP_WCEC_PLUGIN_KEY . '/rightpress-' . apply_filters('plugin_locale', get_locale(), 'rightpress') . '.mo');
        load_plugin_textdomain('rp_wcec', false, dirname(plugin_basename(__FILE__)) . '/languages/');
        load_plugin_textdomain('rightpress', false, RP_WCEC_PLUGIN_KEY . '/languages/');

        // Additional Plugins page links
        add_filter('plugin_action_links_' . (RP_WCEC_PLUGIN_KEY . '/' . RP_WCEC_PLUGIN_KEY . '.php'), array($this, 'plugins_page_links'));

        // Activation hook
        register_activation_hook(__FILE__, array($this, 'activate'));

        // Include RightPress library loader class
        require_once RP_WCEC_PLUGIN_PATH . 'rightpress/rightpress-loader.class.php';
    ...
    public function on_plugins_loaded()
    {
        ...
        require_once RP_WCEC_PLUGIN_PATH . 'classes/abstract/rp-wcec-post-object.class.php';

        // Load classes
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-ajax.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-block.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-conditions.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-email.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-form-builder.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-helper.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-log-entry.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-macros.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-mailer.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-scheduler.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-styling.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-trigger.class.php';
        require_once RP_WCEC_PLUGIN_PATH . 'classes/rp-wcec-wc.class.php';
    ...
    public static function check_environment()
    {
        ...
        if (!RightPress_Help::wp_version_gte(RP_WCEC_SUPPORT_WP)) {
        ...
        else if (!RightPress_Help::wc_version_gte(RP_WCEC_SUPPORT_WC)) {
    ...
    public function on_init_pre()
    {
        ...
        require_once RP_WCEC_PLUGIN_PATH . 'classes/integration/rp-wcec-wc-subscriptions.class.php';
    }
    ...
    public static function get_iso_date($date)
    {
        ...
        $datetime = RightPress_Help::date_create_from_format($format, $date);
    ...
    {
        $format = self::get_date_format();
        $datetime = RightPress_Help::date_create_from_format('Y-m-d', $date);
    ...
    public static function html_to_text($html = '')
    {
        ...
        if (!class_exists('RP_Html2Text')) {
            require_once RP_WCEC_PLUGIN_PATH . 'classes/libraries/rp-html2text.class.php';
        }
    ...
    public static function apply_inline_styles($content, $styles = '')
    {
        ...
        if (!class_exists('RP_Emogrifier')) {
            require_once RP_WCEC_PLUGIN_PATH . 'classes/libraries/rp-emogrifier.class.php';
        }
