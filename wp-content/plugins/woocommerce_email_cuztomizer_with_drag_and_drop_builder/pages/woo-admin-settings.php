...
<div class="wrap woo_email_customizer_settings_con">
    ...
    <div class="woo_email_customizer_settings_nav_con" id="email-builder">
        <ul class="nav nav-tabs">
            ...
            <li<?php echo ($settings_page == 'integrations')? ' class="active"': ''; ?>><a href="<?php echo admin_url("admin.php?page=woo_email_customizer_page_builder&settings=integrations"); ?>"><?php esc_html_e('Retainful - Next order coupon', 'woo-email-customizer-page-builder'); ?></a></li>
        </ul>
        <div class="clear"></div>
